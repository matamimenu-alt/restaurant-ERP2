...
export const downloadTemplate = async (req: AuthRequest, res: Response) => {
  ...
  const templates: Record<string, { headers: string[]; sample: Record<string, unknown>; filename: string }> = {
    ...
    purchase: {
      ...
      headers: ['رقم الفاتورة', 'تاريخ الفاتورة', 'المورد', 'المطعم', 'نوع الفاتورة', 'المبلغ قبل الضريبة', 'مبلغ الضريبة', 'الإجمالي', 'طريقة الدفع', 'ملاحظات'],
      sample: { 'رقم الفاتورة': 'INV-001', 'تاريخ الفاتورة': '2024-01-01', 'المورد': 'اسم المورد', 'المطعم': 'اسم المطعم', 'نوع الفاتورة': 'TAX', 'المبلغ قبل الضريبة': 1000, 'مبلغ الضريبة': 150, 'الإجمالي': 1150, 'طريقة الدفع': 'نقد', 'ملاحظات': '' },
    },
  };
